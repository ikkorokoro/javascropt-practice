...
// 下記のコードはfn2はfn1関数スコープ内(fn1の{}中のため)、関数fn2の中からlet b = 1;を呼び出すことができる
let a = 2;
function fn1() {
    let b = 1;
    function fn2() {
...
// 以下の場合、fn4の関数から変数fの呼び出しはfn3の関数のスコープ外となるためとエラーが出る
let e = 2;
function fn3() {
    let f = 1;
}
...
関数スコープ(fn1)
  ...
  関数スコープ(fn2)
    c
関数スコープ(fn1)はグローバルスコープのa,b1を参照することができる
関数スコープ(fn2)はfn1のスコープ内であるため、
